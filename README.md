...
- [User Manual](https://github.com/HoneyHazard/PixelMatchSwitcher/wiki/User-Manual)
  ...
  - [Basic concepts](#basic-concepts)
      ...
      + [Match Image Mask](#match-image-mask)
      + [Match Parameters](#match-parameters)
        - [Mask Mode](#mask-mode)
        - [X and Y location](#x-and-y-location)
        - [Allowed Pixel Error](#allowed-pixel-error)
        - [Match Threshold](#match-threshold)
      + [Match Image Capture](#match-image-capture)
        - [Snapshot Image Capture](#snapshot-image-capture)
        - [Automask Image Capture](#automask-image-capture)
      + [Match Result](#match-result)
      + [Target Scene](#target-scene)
      + [Match List](#match-list)
      + [No-match Target](#no-match-target)
      + [Linger Delay](#linger-delay)
      + [Preset](#preset)
